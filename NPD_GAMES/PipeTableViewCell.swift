...
class PipeTableViewCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource{
    //Cell title
    @IBOutlet weak var titleLabel: UILabel!
    //Cell images
    @IBOutlet weak var collectionView: UICollectionView!
    //Collection height constraint
    ...
    override func awakeFromNib() {
        ...
        self.collectionView!.register(UINib(nibName:"PipeCollectionViewCell", bundle:nil),
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: "myCollectionCell", for: indexPath) as! PipeCollectionViewCell
...
//        selectedBGView.layer.borderColor = UIColor.red.cgColor
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let cell = collectionView.cellForItem(at: indexPath) as! PipeCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        ...
        guard let cell = collectionView.cellForItem(at: indexPath) as? PipeCollectionViewCell else {
